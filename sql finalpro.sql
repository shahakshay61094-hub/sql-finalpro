...
insert into student (studentid, firstname, lastname, email, birthdate, enroolmentdate)
values
(3, 'rohan', 'mehta', 'rohan.mehta@gmail.com', '2001-07-15', '2023-08-01');

select * from student;

update student
set email = 'ajay.varma@gmail.com'
where studentid = 1;
